...
import rnn_utils
# 手写LSTM的前向反向传播
def lstm_cell_forward(xt, a_prev, c_prev, parameters):  # LSTM单元的前向传播。
    """
    参数：
...
def lstm_forward(x, a0, parameters):  # LSTM单元组成的的循环神经网络
    """
    参数：
...
def lstm_cell_backward(da_next, dc_next, cache):  # LSTM的单步反向传播
    """
    参数：
...
def lstm_backward(da, caches):   # LSTM网络的反向传播
    """
    参数：
